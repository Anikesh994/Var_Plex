...
const shapes = [
  {
    ...
    position: "-top-40 -left-40",
    gradient:
      "bg-[radial-gradient(circle,#10b981_0%,#10b981_25%,transparent_65%)] opacity-35 blur-3xl",
  },
  {
    id: 2,
    size: "w-[550px] h-[550px]",
    position: "-bottom-40 -right-40",
    gradient:
      "bg-[radial-gradient(circle,#0ea5e9_0%,#0ea5e9_25%,transparent_65%)] opacity-35 blur-3xl",
  },
  {
    id: 3,
    size: "w-[400px] h-[400px]",
    position: "top-14 right-[8%]",
    gradient:
      "bg-[radial-gradient(circle,#8b5cf6_0%,#8b5cf6_30%,transparent_70%)] opacity-30 blur-3xl",
  },
  {
    id: 4,
    size: "w-[380px] h-[380px]",
    position: "bottom-16 left-[14%]",
    gradient:
      "bg-[radial-gradient(circle,#3b82f6_0%,#3b82f6_30%,transparent_70%)] opacity-30 blur-3xl",
  },
  {
    id: 5,
    size: "w-[340px] h-[340px]",
    position: "top-[38%] left-[43%]",
    gradient:
      "bg-[radial-gradient(circle,#6366f1_0%,#6366f1_35%,transparent_75%)] opacity-25 blur-3xl",
  },
];
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none ">
      {shapes.map((shape) => (
        <div
          key={shape.id}
          className={`absolute ${shape.size} ${shape.position}  ${shape.gradient} rounded-full  animate-pulse`}
          style={{
